 ...
 * The plan selection happens after account creation in the workspace creation flow.
 *
 * @example
 * ```ts
 ...
 * ```
 *
 * @throws {ZodError} When any field is missing, too short, or passwords don't match.
