...
export function CreateTemplateDialog({
  ...
  const handleSubmit = async (data: CreateTemplateFormData) => {
    ...
    try {
      // IMPORTANTE: Passar workspaceId para criar template workspace-scoped
      const result = await createDigitalTemplateAction(data, workspaceId);
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Este template ficará disponível apenas para este workspace
          </DialogDescription>
        </DialogHeader>
