...
export function TemplateCard({ template }: TemplateCardProps) {
  ...
  // REGRA DE SEGURANÇA: Usuários só podem editar/deletar templates de workspace (não globais)
  const canEdit = !!template.workspaceId;
      ...
      <Card className="overflow-hidden hover:shadow-md transition-shadow">
        <CardContent className="p-4 space-y-3">
          ...
          <div className="flex items-start justify-between gap-2">
            ...
            {/* IMPORTANTE: Dropdown só é renderizado se canEdit === true */}
            {canEdit && (
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                  <DropdownMenuItem asChild>
                    <Link href={`/${locale}/app/${workspaceSlug}/tools/smart-cards/templates/${template.id}`}>
          ...
          {/* Footer: Data (esquerda) + Tag (direita) + Badge Global */}
