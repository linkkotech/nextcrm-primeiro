  ...
  const {
    ...
    defaultValues: {
      ...
      styles: {
        ...
        textColor: ((heroBlock?.content as HeroBlockContent)?.styles?.textColor as string) || '#000000',
        textAlignment: ((heroBlock?.content as HeroBlockContent)?.styles?.textAlignment as 'center' | 'left' | 'justify' | 'right') || 'center',
        backgroundColor: ((heroBlock?.content as HeroBlockContent)?.styles?.backgroundColor as string) || '#ffffff',
        // EXISTING FIELDS
        blockBackgroundColor: ((heroBlock?.content as HeroBlockContent)?.styles?.blockBackgroundColor as string) || '#ffffff',
        blockTitleColor: ((heroBlock?.content as HeroBlockContent)?.styles?.blockTitleColor as string) || '#ffffff',
        blockSubtitleColor: ((heroBlock?.content as HeroBlockContent)?.styles?.blockSubtitleColor as string) || '#ffffff',
        blockTextColor: ((heroBlock?.content as HeroBlockContent)?.styles?.blockTextColor as string) || '#ffffff',
        blockLinkColor: ((heroBlock?.content as HeroBlockContent)?.styles?.blockLinkColor as string) || '#0066cc',
        buttonBackgroundColor: ((heroBlock?.content as HeroBlockContent)?.styles?.buttonBackgroundColor as string) || '#0066cc',
        buttonTextColor: ((heroBlock?.content as HeroBlockContent)?.styles?.buttonTextColor as string) || '#ffffff',
        borderWidth: ((heroBlock?.content as HeroBlockContent)?.styles?.borderWidth as number) || 0,
        borderColor: ((heroBlock?.content as HeroBlockContent)?.styles?.borderColor as string) || '#000000',
        ...
        boxShadowColor: ((heroBlock?.content as HeroBlockContent)?.styles?.boxShadowColor as string) || '#000000',
      },
    },
  });
