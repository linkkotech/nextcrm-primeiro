...
export function CTAEditor({
  ...
  const form = useForm<z.input<typeof ctaBlockContentSchema>, unknown, z.output<typeof ctaBlockContentSchema>>({
  ...
  const formValues = watch() as CTABlockContent;
      ...
      <div className="space-y-4 border-t pt-4">
        ...
        <div>
          <ToggleGroup
            ...
            onValueChange={(value) => {
              if (value) setValue('textAlignment', value as 'left' | 'center' | 'right' | 'justify');
            }}
